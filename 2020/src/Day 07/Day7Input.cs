...
namespace AdventOfCode2020.Day_07
{
    public class Day7Input
    {
        private const string Input = @"shiny purple bags contain 2 pale blue bags, 1 wavy fuchsia bag, 5 pale salmon bags.
...
dotted aqua bags contain 1 mirrored green bag, 5 shiny maroon bags.";
        ...
        public static ImmutableList<Bag> CreateBagsFromInput()
        {
            return Input.Split("\r\n").Select(BagFactory.CreateBagFromString).ToImmutableList();
        }
    }
}
