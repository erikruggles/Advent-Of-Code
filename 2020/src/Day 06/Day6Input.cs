...
namespace AdventOfCode2020.Day_06
{
    ...
    {
        private const string Input = @"donpevkjhymzl
ezyopckdlnvmj
...
lmzuqfewdjsvrgtahbiny";
        ...
        public static ImmutableList<PassengerGroup> ParsePassengerGroups()
        {
            return Input.Split("\r\n\r\n").Select(PassengerGroupFactory.CreatePassengerGroupFromString).ToImmutableList();
        }
    }
}
