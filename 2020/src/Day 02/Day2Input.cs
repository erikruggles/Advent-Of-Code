...
namespace AdventOfCode2020.Day_02
{
    ...
    {
        private const string Input = @"15-16 m: mhmjmzrmmlmmmmmm
5-6 d: dcdddhzld
3-4 s: vqssdcbl
3-6 b: bbhbbbqbbb
10-11 q: cqqntqhqwwh
...
9-16 d: dsdddddddrdddddhdbdd";
        ...
        public static ImmutableList<PasswordAndPolicy> GetPasswordAndPolicies()
        {
            var rawPasswordAndPolicies = Input.Split("\r\n");

            return rawPasswordAndPolicies.Select(PasswordAndPolicyFactory.ParseFromRawPasswordAndPolicyString).ToImmutableList();
        }
    }
}
