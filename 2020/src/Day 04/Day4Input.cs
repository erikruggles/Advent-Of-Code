...
namespace AdventOfCode2020.Day_04
{
    public class Day4Input
    {
        private const string Input = @"eyr:2028 iyr:2016 byr:1995 ecl:oth
...
hcl:#602927 iyr:2013 byr:2003 eyr:2023 cid:100";
        ...
        public static ImmutableList<Passport> ParseAllPassports()
        {
            var passportInput = Input.Split("\r\n\r\n");
            return passportInput.Select(PassportFactory.ParsePassportFromString).ToImmutableList();
        }
    }
}