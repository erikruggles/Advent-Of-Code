...
namespace AdventOfCode2020.Test.Day05
{
    public class Day5
    {
        ...
        {
            var (minRow, minSeatId) = Day_05.Day5.DetermineMinimumRowFromListOfSeatIds(new List<int> { 17, 10, 123, 29, 615});
        ...
        {
            var (maxRow, maxSeatId) = Day_05.Day5.DetermineMaximumRowFromListOfSeatIds(new List<int> { 17, 10, 123, 29, 615});
